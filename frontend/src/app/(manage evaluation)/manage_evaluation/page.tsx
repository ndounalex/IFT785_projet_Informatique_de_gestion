  ...
  const columns: GridColDef[] = [
    //{ field: 'id', headerName: 'ID', width: 70 },
    {
      ...
      getActions: (employee:any) => {
        return [
          <IconButton key="1_manage_evaluation" aria-label="edit" size="small" onClick={editEmployeeItem.bind(this, employee.id)}>
            <EditIcon fontSize="small" />
          </IconButton>,
          <IconButton key="2_manage_evaluation" aria-label="delete" size="small"  onClick={deleteEmployeeItem.bind(this, employee.id)}>
